...
2. [给`@Janus`注解设置唯一键](#jump-target-methodId)。
3. [选择合适的比对模式](#jump-target-select-compareType)。
...
## <span id="jump-target-methodId">唯一键</span>
...
### <span id="jump-target-select-compareType">比对模式选择</span>
